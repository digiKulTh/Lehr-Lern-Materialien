# Handreichung Rechtliche Aspekte der Objektdigitalisierung
...
### Relevante Schranken des Urheberrechts
...
- [ ] If copyright protection exists, is there a license for use (cf. [Transfer of rights and types of licensing](#transfer-of-rights-and-licenses), [Copyright in employment relationships, internships, etc.](#copyright-in-employment-relationships-internships-etc))?

**Rights to One's Own Image**

- [ ] Can people in a digitized photo negative or print be identified (cf. [Right to One’s Own Image](#right-to-ones-own-image))?
